...
class ECAPA_TDNN(nn.Module):
    ...
    def __init__(self, C, spk_embedding_dim, n_mels):
        ...
        self.fc6 = nn.Linear(3072, spk_embedding_dim)
        self.bn6 = nn.BatchNorm1d(spk_embedding_dim)
